const commentForm = document.getElementById('CommentForm');
            const holderDiv = document.querySelector('.holderr');
            ...
            commentForm.addEventListener('submit', (e) => {
                ...
                let existingComments1 = JSON.parse(localStorage.getItem('comments1')) || []
               ...
               if(LoggedInUser) {
                existingComments1.push(comments)
                alert('Comment Added')
               }
              
        
                localStorage.setItem('comments1', JSON.stringify(existingComments1))
                
        
                displayComments(existingComments1);
            });
